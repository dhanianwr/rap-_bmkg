...
export function EditHariIni() {
  ...
  //UPDATED METHOD
  const updateWisataHariIni = async (e) => {
    e.preventDefault();
    await axios.patch(`http://localhost:5000/wisata/${id}`, {
      name: name,
      weather: weather,
      wind: wind,
      temp: temp,
      ...
      <div className="mb-0 rounded-t border-b-[1px] border-b-gray-300 bg-white p-2">
        <div className="flex justify-between text-center">
          <h6 className="text-blueGray-700 text-xl">
            Edit Data Tempat Wisata / Prakiraan Hari Ini
          </h6>
        </div>
      </div>
      <div className="flex-auto bg-[#ffffffe5] px-4 py-10 pt-0 lg:px-6">
        <form onSubmit={updateWisataHariIni}>
